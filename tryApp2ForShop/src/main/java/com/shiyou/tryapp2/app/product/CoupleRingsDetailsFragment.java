...
public class CoupleRingsDetailsFragment extends BaseFragment
{
	...
	public CoupleRingsDetailsFragment(CoupleRingDetailResponse response, float[] weightRange, int[] priceRange)
	{
		...
		this.goodsId = String.valueOf(response.data.id);
//		this.mCoupleRingErpDetail = response.data.erp;
	...
	{
//		Log.d(TAG, "onCreateView: tagname="+mCoupleRingDetailResponse.data.tagname);
...
//		this.mCoupleRingErpDetail = response.data.erp;
		...
		AndroidUtils.MainHandler.post(new Runnable()
		{
			...
			public void run()
			{
				...
				if (isResumed())
				{
					if (mCoupleRingDetailResponse.data.title != null)
						productName.setText(mCoupleRingDetailResponse.data.title);
//					if (mCoupleRingDetailResponse.data.sku != null)
//						product_kh.setText(mCoupleRingDetailResponse.data.sku);
//					if (mCoupleRingDetailResponse.data.m_sku != null)
//						menProductNumber.setText(mCoupleRingDetailResponse.data.m_sku);
//					if (mCoupleRingDetailResponse.data.w_sku != null)
//						wmenProductNumber.setText(mCoupleRingDetailResponse.data.w_sku);
