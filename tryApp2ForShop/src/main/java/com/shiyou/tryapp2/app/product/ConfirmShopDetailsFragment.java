...
//							if (mGDResponse.data.param[2].value2 == null)
//							{
//								showLoadingIndicator();
...
//								return;
//							}
//							if (mGDResponse != null && mGDResponse.data != null)
//							{
//								AndroidUtils.MainHandler.post(new Runnable()
//								{
//									@Override
//									public void run()
//									{
//										productID = mGDResponse.data.id;
//										productName.setText(mGDResponse.data.title);
//
//										if (mGDResponse.data.param != null && mGDResponse.data.param.length > 0)
//										{
//											product_number.setText(mGDResponse.data.sku);
//
...
//																	+ mGDResponse.data.param[2].value);
