...
public class SwipeLayout extends FrameLayout {
    ...
    public SwipeLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        try
		{
			...
			int[] styleableArray = ResourceUtil.getStyleableArray(context, "SwipeLayout");
			TypedArray a = context.obtainStyledAttributes(attrs, styleableArray);
			int styleable = ResourceUtil.getStyleableId(context, "SwipeLayout_drag_edge");
			int dragEdgeChoices = a.getInt(styleable, DRAG_RIGHT);
			styleable = ResourceUtil.getStyleableId(context, "SwipeLayout_leftEdgeSwipeOffset");
			mEdgeSwipesOffset[DragEdge.Left.ordinal()] = a.getDimension(styleable, 0);
			styleable = ResourceUtil.getStyleableId(context, "SwipeLayout_rightEdgeSwipeOffset");
			mEdgeSwipesOffset[DragEdge.Right.ordinal()] = a.getDimension(styleable, 0);
			styleable = ResourceUtil.getStyleableId(context, "SwipeLayout_topEdgeSwipeOffset");
			mEdgeSwipesOffset[DragEdge.Top.ordinal()] = a.getDimension(styleable, 0);
			styleable = ResourceUtil.getStyleableId(context, "SwipeLayout_bottomEdgeSwipeOffset");
			mEdgeSwipesOffset[DragEdge.Bottom.ordinal()] = a.getDimension(styleable, 0);
			styleable = ResourceUtil.getStyleableId(context, "SwipeLayout_clickToClose");
			setClickToClose(a.getBoolean(styleable, mClickToClose));
			...
			styleable = ResourceUtil.getStyleableId(context, "SwipeLayout_show_mode");
			int ordinal = a.getInt(styleable, ShowMode.PullOut.ordinal());
