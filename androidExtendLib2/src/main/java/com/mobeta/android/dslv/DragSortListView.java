...
public class DragSortListView extends ListView {
	...
	public DragSortListView(Context context, AttributeSet attrs, int defStyle) {
        ...
        try
		{
			...
			if (attrs != null) {
				int[] styleableArray = ResourceUtil.getStyleableArray(getContext(), "DragSortListView");
			    TypedArray a = getContext().obtainStyledAttributes(attrs, styleableArray, defStyle, 0);

			    int styleable = ResourceUtil.getStyleableId(getContext(), "DragSortListView_collapsed_height");
			    mItemHeightCollapsed = Math.max(1, a.getDimensionPixelSize(styleable, 1));

			    styleable = ResourceUtil.getStyleableId(getContext(), "DragSortListView_track_drag_sort");
			    mTrackDragSort = a.getBoolean(styleable, false);
			    ...
			    styleable = ResourceUtil.getStyleableId(getContext(), "DragSortListView_float_alpha");
			    mFloatAlpha = a.getFloat(styleable, mFloatAlpha);
			    mCurrFloatAlpha = mFloatAlpha;

			    styleable = ResourceUtil.getStyleableId(getContext(), "DragSortListView_drag_enabled");
			    mDragEnabled = a.getBoolean(styleable, mDragEnabled);

			    styleable = ResourceUtil.getStyleableId(getContext(), "DragSortListView_slide_shuffle_speed");
			    mSlideRegionFrac = Math.max(0.0f,
			            Math.min(1.0f, 1.0f - a.getFloat(styleable, 0.75f)));

			    mAnimate = mSlideRegionFrac > 0.0f;

			    styleable = ResourceUtil.getStyleableId(getContext(), "DragSortListView_drag_scroll_start");
			    float frac = a.getFloat(styleable, mDragUpScrollStartFrac);

			    setDragScrollStart(frac);

			    styleable = ResourceUtil.getStyleableId(getContext(), "DragSortListView_max_drag_scroll_speed");
			    mMaxScrollSpeed = a.getFloat(styleable, mMaxScrollSpeed);

			    styleable = ResourceUtil.getStyleableId(getContext(), "DragSortListView_remove_animation_duration");
			    removeAnimDuration = a.getInt(styleable, removeAnimDuration);

			    styleable = ResourceUtil.getStyleableId(getContext(), "DragSortListView_drop_animation_duration");
			    dropAnimDuration = a.getInt(styleable, dropAnimDuration);

			    styleable = ResourceUtil.getStyleableId(getContext(), "DragSortListView_use_default_controller");
			    boolean useDefault = a.getBoolean(styleable, true);

			    if (useDefault) {
			    	styleable = ResourceUtil.getStyleableId(getContext(), "DragSortListView_remove_enabled");
			        boolean removeEnabled = a.getBoolean(styleable, false);
			        styleable = ResourceUtil.getStyleableId(getContext(), "DragSortListView_remove_mode");
			        int removeMode = a.getInt(styleable, DragSortController.FLING_REMOVE);
			        styleable = ResourceUtil.getStyleableId(getContext(), "DragSortListView_sort_enabled");
			        boolean sortEnabled = a.getBoolean(styleable, true);
			        styleable = ResourceUtil.getStyleableId(getContext(), "DragSortListView_drag_start_mode");
			        int dragInitMode = a.getInt(styleable, DragSortController.ON_DOWN);
			        int id = ResourceUtil.getId(getContext(), "drag_handle");
			        styleable = ResourceUtil.getStyleableId(getContext(), "DragSortListView_drag_handle_id");
			        int dragHandleId = a.getResourceId(styleable, id);
			        id = ResourceUtil.getId(getContext(), "fling_handle");
			        styleable = ResourceUtil.getStyleableId(getContext(), "DragSortListView_fling_handle_id");
			        int flingHandleId = a.getResourceId(styleable, id);
			        id = ResourceUtil.getId(getContext(), "click_remove");
			        styleable = ResourceUtil.getStyleableId(getContext(), "DragSortListView_click_remove_id");
			        int clickRemoveId = a.getResourceId(styleable, id);
			        styleable = ResourceUtil.getStyleableId(getContext(), "DragSortListView_float_background_color");
			        int bgColor = a.getColor(styleable, Color.BLACK);
     ...
     * move the check state from the item's old position to the new position 閳ワ拷
